   ...
   <div id="left-side" class="lfc h-full pt-14 overflow-y-scroll overflow-x-hidden w-full md:w-3/5 " >
	...
	<section id="section-projects">
		<div class="ls-h mb-4 relative">
                <button aria-label="Open Side Menu" id="menu_toggle" class="icon-bars menu-phone inline md:hidden "></button>
		...
		<div class="ls-pr-ct flex -mr-4 -ml-4 text-center p-6 justify-center flex-col items-center">
				<h1>Visit my own <a rel="noopener" href="https://gitlab.flashsoft.eu/explore/projects?sort=created_desc" class="gitlab-button">GitLab instance server</a> to see some of the public git repositories containing open source code .</h1>
				 <a  rel="noopener" href="https://gitlab.flashsoft.eu/explore/projects?sort=latest_activity_desc">
                                <img
                                         srcset="/res/gitlabpreview-1-2.png 2x,
                                                 /res/gitlabpreview-1-3.png 3x,
                                                 /res/gitlabpreview.png 4x"
                                        src="res/gitlabpreview.png" alt="flashsoft.eu gitlab server"
                                width="550"
                                height="259"
                                  />
                                 </a>
				 <p>Also you can visit my <a href="/" class="gitlab-button">Certifications/Courses DB</a>.</p>
		 
	</div>
	</section>
	<section id="section-skills">
		<div class="ls-h ls-skh mb-4">					<p class="my-1">Skills</p>
		</div>
...
<img src="/res/devicon/amp/amp-opt.svg" width="64" height="64" loading="lazy" alt="AMP logo">   
     
<img src="/res/devicon/html5/html5-original.svg" width="64" height="64" loading="lazy" alt="html5 logo">
     
<img src="/res/devicon/css3/css3-original.svg" width="64" height="64" loading="lazy" alt="css3 logo">    
     
<img src="/res/devicon/sass/sass-original.svg" width="64" height="64" loading="lazy" alt="sass logo"> 			 
 
<img src="/res/devicon/tailwind/tailwind-opt.svg" width="64" height="64" loading="lazy" alt="tailwind logo">       

<img src="/res/devicon/javascript/javascript-original.svg" width="64" height="64" loading="lazy" alt="javascript logo">

<img src="/res/devicon/typescript/typescript-original.svg" width="64" height="64" loading="lazy" alt="Webpack logo">

<img src="/res/devicon/react/react-original.svg" width="64" height="64" loading="lazy" alt="react logo">

<img src="/res/devicon/vuejs/vuejs-original.svg" width="64" height="64" loading="lazy" alt="vue logo">
     
<img src="/res/devicon/angularjs/angularjs-original.svg" width="64" height="64" loading="lazy" alt="Angular logo">

<img src="/res/devicon/python/python-original.svg" width="64" height="64" loading="lazy" alt="python logo">    

<img src="/res/devicon/php/php-plain.svg" width="64" height="64" loading="lazy" alt="php logo">

<img src="/res/devicon/nodejs/nodejs-original.svg" width="64" height="64" loading="lazy" alt="nodejs logo">     

<img src="/res/devicon/c/c-original.svg" width="64" height="64" loading="lazy" alt="c-lang logo">

<img src="/res/devicon/cplusplus/cplusplus-original.svg" width="64" height="64" loading="lazy" alt="cplusplus-lang logo">

<img src="/res/devicon/qt/qt-round.svg" width="64" height="64" loading="lazy" alt="qt logo">
 
<img src="/res/devicon/csharp/csharp-original.svg" width="64" height="64" loading="lazy" alt="csharp-lang logo">
     
<img src="/res/devicon/dot-net/dot-net-plain-wordmark.svg" width="64" height="64" loading="lazy" alt="dot-net logo">

<img src="/res/devicon/kotlin/kotlin-original.svg" width="64" height="64" loading="lazy" alt="java logo">     

<img src="/res/devicon/java/java-original.svg" width="64" height="64" loading="lazy" alt="java logo">

<img src="/res/devicon/laravel/laravel-plain.svg" width="64" height="64" loading="lazy" alt="laravel logo">		 
			
<img src="/res/devicon/symfony/symfony-original.svg" width="64" height="64" loading="lazy" alt="symfony logo">			 

<img src="/res/devicon/codeigniter/codeigniter-plain.svg" width="64" height="64" loading="lazy" alt="codeigniter logo">	

<img src="/res/devicon/flask/flask-opt.svg" width="64" height="64" loading="lazy" alt="flask logo">

<img src="/res/devicon/ssh/ssh-original.svg" width="64" height="64" loading="lazy" alt="ssh logo">   

<img src="/res/devicon/bash/bash-original.svg" width="64" height="64" loading="lazy" alt="bash logo">
     
<img src="/res/devicon/autoit/autoit.svg" width="64" height="64" loading="lazy" alt="autoit logo">
 
<img src="/res/devicon/linux/toxOpt.svg" width="64" height="64" loading="lazy" alt="linux logo">   
 					
<img src="/res/devicon/debian/debian-original.svg" width="64" height="64" loading="lazy" alt="debian logo">
     
<img src="/res/devicon/redhat/redhat-plain.svg" width="64" height="64" loading="lazy" alt="redhat logo">

<img src="/res/devicon/ubuntu/ubuntu-plain.svg" width="64" height="64" loading="lazy" alt="ubuntu logo">  

<img src="/res/devicon/docker/docker-plain.svg" width="64" height="64" loading="lazy" alt="ubuntu logo">
     
<img src="/res/devicon/nginx/nginx.svg" width="64" height="64" loading="lazy" alt="linux logo">  

<img src="/res/devicon/apache/apache-opt.svg" width="64" height="64" loading="lazy" alt="apache logo"> 

<img src="/res/devicon/oracle/oracle-original.svg" width="64" height="64" loading="lazy" alt="oracle logo">

<img src="/res/devicon/postgresql/postgres-opt.svg" width="64" height="64" loading="lazy" alt="postgres logo"> 

<img src="/res/devicon/mysql/mysql-original.svg" width="64" height="64" loading="lazy" alt="mysql logo">

<img src="/res/devicon/redis/redis-original.svg" width="64" height="64" loading="lazy" alt="redis logo">
     
<img src="/res/devicon/mongodb/mongodb-original.svg" width="64" height="64" loading="lazy" alt="mongodb logo">

<img src="/res/devicon/android/android-plain.svg" width="64" height="64" loading="lazy" alt="android logo">
     
<img src="/res/devicon/ionic/ionic-original.svg" width="64" height="64" loading="lazy" alt="ionic logo">

<img src="/res/devicon/gradle/gradle-plain.svg" width="64" height="64" loading="lazy" alt="gradle logo">

<img src="/res/devicon/composer/composer-opt.svg" width="64" height="64" loading="lazy" alt="composer logo">

<img src="/res/devicon/npm/npm-original-wordmark.svg" width="64" height="64" loading="lazy" alt="composer logo">
     
<img src="/res/devicon/yarn/yarn-original.svg" width="64" height="64" loading="lazy" alt="composer logo">
     
<img src="/res/devicon/git/git-original.svg" width="64" height="64" loading="lazy" alt="git logo">
 
<img src="/res/devicon/gitlab/gitlab-original.svg" width="64" height="64" loading="lazy" alt="github logo">
     
<img src="/res/devicon/github/github-original.svg" width="64" height="64" loading="lazy" alt="github logo">

<img src="/res/devicon/visualstudio/visualstudio-plain.svg" width="64" height="64" loading="lazy" alt="visualstudio logo">
				
<img src="/res/devicon/netbeans/netbeans-opt.svg" width="64" height="64" loading="lazy" alt="netbeans logo">

<img src="/res/devicon/eclipse/eclipseOpt.svg" width="64" height="64" loading="lazy" alt="eclipse logo">

<img src="/res/devicon/photoshop/photoshop-plain.svg" width="64" height="64" loading="lazy" alt="photoshop logo">

<img src="/res/devicon/inkscape/inkscape-plain.svg" width="64" height="64" loading="lazy" alt="inkscape logo">

<img src="/res/devicon/materialui/materialui-original.svg" width="64" height="64" loading="lazy" alt="bootstrap logo">
     
<img src="/res/devicon/bulma/bulma.svg" width="64" height="64" loading="lazy" alt="bulma logo">   

<img src="/res/devicon/bootstrap/bootstrap-plain.svg" width="64" height="64" loading="lazy" alt="bootstrap logo">
     
<img src="/res/devicon/jquery/jquery-plain.svg" width="64" height="64" loading="lazy" alt="jquery logo">      
 
<img src="/res/devicon/webpack/webpack-original.svg" width="64" height="64" loading="lazy" alt="Webpack logo">			
     
<img src="/res/devicon/moodle/moodle-original.svg" width="64" height="64" loading="lazy" alt="moodle logo">
			
<img src="/res/devicon/wordpress/wordpress-plain.svg" width="64" height="64" loading="lazy" alt="wordpress logo">
  ...
  <ul class="tags blue mb-6">
	...
	<section id="section-contact">
		...
		<div id="ls-ct-fr" class="ls-ct-fr">
                        <div id="spinner" class="spinner spinner__1"></div>
				...
				<textarea id="form-message" name="message" cols="30" rows="5" placeholder="Message"></textarea>
				  
                        <button id="form-submit" type="submit" value="Send" class="btn-submit"><i class="icon-paper-plane-o"></i>&nbsp;Send&nbsp;</button>
   ...
   <nav id="side-menu" class="fixed w-11/12 h-full top-0 left-0 overflow-auto bg-white">
    <button aria-label="Close Side Menu" id="menu-close">×</button>
		...
		<ul class="sidebar-menu-nav">
			<li class="sidemenu" ><a id="lsm-projects"  href="#section-projects"><i class="icon-home text-custom-v" aria-hidden="true"></i>Projects</a></li>
			<li class="sidemenu" ><a id="lsm-skills" href="#section-skills"><i class="icon-user-circle-o text-custom-v" aria-hidden="true"></i>Skills</a></li>
			<li class="sidemenu" ><a id="lsm-tech" href="#section-tech"><i class="icon-server text-custom-v" aria-hidden="true"></i>Technology</a></li>
			<li class="sidemenu" ><a id="lsm-interests" href="#section-interests"><i class="icon-tags text-custom-v" aria-hidden="true"></i>Interests</a></li>
			<li class="sidemenu" ><a id="lsm-contact" href="#section-contact"><i class="icon-envelope text-custom-v"></i>Contact</a></li>
		</ul>
	      <div class="rst-sb text-2xl mt-16 ">
			<p class="text-gray-900 ">andrei<svg width="142mm" height="142mm"
   viewBox="0 0 142 142"
   class="at-sign-sidebar">
  <g id="at-sign-path">
    <path
...
</svg>flashsoft.eu<span class="rst-s block ml-8" >(andrei0x309)</span></p>
		</div>
		<div class="rsd-sb">
...
<div class="flex pl-16">
 <ul>
  <li><a rel="noopener noreferrer" class="text-gray-600 p-2 inline-block" href="https://blog.flashsoft.eu" target="_blank">My Blog <i class="icon-my-blog text-custom-v"></i></a></li>
  <li><a rel="noopener noreferrer" class="text-gray-600 p-2 inline-block" href="https://gitlab.flashsoft.eu/explore/projects?sort=latest_activity_desc" target="_blank">GitLab <i class="icon-gitlab text-custom-v" ></i></a></li>
  <li><a rel="noopener nofollow noreferrer" class="text-gray-600 p-2 inline-block" href="https://www.linkedin.com/in/andrei0x309/" target="_blank">Linkedin <i class="icon-linkedin text-custom-v"></i></a></li>
 </ul>

 <ul>
  <li><a rel="noopener nofollow noreferrer" class="text-gray-600 p-2 inline-block" href="https://www.goodreads.com/user/show/52338687-andrei" target="_blank">Goodreads <i class="icon-goodreads text-custom-v" ></i></a></li>
  <li><a rel="noopener nofollow noreferrer" class="text-gray-600 p-2 inline-block" href="https://pinterest.com/andrei0x309/" target="_blank">Pinterest <i  class="icon-pinterest-square text-custom-v"></i></a></li>
  <li><a rel="noopener nofollow noreferrer" class="text-gray-600 p-2 inline-block"  href="https://www.reddit.com/user/andrei0x309" target="_blank">Reddit <i  class="icon-reddit text-custom-v"></i></a></li>
...
<nav class="rsn pt-18">
		<ul class="leading-[3.2rem] text-[1.4rem]">
			<li><i class="icon-bars"></i></li>
                        <li><a rel="section" href="#section-projects"><i class="icon-home" aria-hidden="true"></i>Projects</a></li>
			<li><a rel="section" href="#section-skills"><i class="icon-user-circle-o" aria-hidden="true"></i>Skills</a></li>
			<li><a rel="section" href="#section-tech"><i class="icon-server" aria-hidden="true"></i>Technology</a></li>
			<li><a rel="section" href="#section-interests"><i class="icon-tags" aria-hidden="true"></i>Interests</a></li>
  ...
  <div class="computer-bottom">
   <div class="keyboard">
   <svg width="99.056175" height="13.977751" viewBox="0 0 99.056176 13.977751" class="keyboard">
 ...
 <div class="rst">
<p class="text-2xl">andrei<svg width="142mm"
   height="142mm"
   viewBox="0 0 142 142"
   class="at-sign-main">
 <use href="#at-sign-path" />
</svg>flashsoft.eu
                        <span class="rst-s block ml-8" >(andrei0x309)</span></p>
		</div>
                <div class="rsd">
			<p>Web Developer</p>
		...
		<div class="rs-slc inline-block ml-p10 mt-p10">
			<ul class="rs-links-b" >
<li class="relative"><a rel="noopener noreferrer" href="https://blog.flashsoft.eu" target="_blank">My Blog <i class="icon-my-blog rs-slc-nonactive"></i></a></li>
<li class="relative"><a rel="noopener noreferrer" href="https://gitlab.flashsoft.eu/explore/projects?sort=latest_activity_desc" target="_blank">GitLab <i class="icon-gitlab rs-slc-nonactive"></i></a></li>
<li class="relative" ><a rel="noopener nofollow noreferrer"  href="https://www.linkedin.com/in/andrei0x309/" target="_blank">Linkedin <i class="icon-linkedin rs-slc-nonactive"></i></a></li>
			</ul>
		</div>
<div class="rs-slc inline-block mt-p10">
<ul  class="rs-links-b">
<li class="relative"><a rel="noopener nofollow noreferrer" href="https://www.goodreads.com/user/show/52338687-andrei" target="_blank">Goodreads <i id="islc4" class="icon-goodreads rs-slc-nonactive" ></i></a></li>
<li class="relative"><a rel="noopener nofollow noreferrer" href="https://pinterest.com/andrei0x309/" target="_blank">Pinterest <i class="icon-pinterest-square rs-slc-nonactive"></i></a></li>
<li class="relative"><a rel="noopener nofollow noreferrer" href="https://github.com/andrei0x309" target="_blank">GitHub <i class="icon-github-original rs-slc-nonactive "></i></a></li>
