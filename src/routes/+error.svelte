<script lang="ts">
     import "@/routes/tailwind.css";
     import '@/routes/_global.scss';
...
<meta property="og:site_name" content="{config.indexPageTitle}" />
...
<div id="main" class="{`main flex md:flex-row w-full mt-6 mb-6 justify-center`}">
    ...
    <div class="text-center mt-4">
     ...
     <h1 class="text-[1.9rem] p-4">ERROR {errorStatus}</h1>
        ...
        <button class="group relative h-12 w-60 overflow-hidden rounded-lg bg-white text-lg shadow-sm mt-4 cursor-pointer">
            <div class="absolute inset-0 w-3 bg-amber-400 transition-all duration-[250ms] ease-out group-hover:w-full"></div>
            <span class="relative text-black group-hover:text-white text-[1.4rem]"><span class="opacity-60" >➲</span> Return to Home</span>
          </button>
        </a>
        <a href="/projects" class="text-amber-400">
            <button class="group relative h-12 w-60 overflow-hidden rounded-lg bg-white text-lg shadow-sm mt-4 cursor-pointer">
                <div class="absolute inset-0 w-3 bg-amber-400 transition-all duration-[250ms] ease-out group-hover:w-full"></div>
                <span class="relative text-black group-hover:text-white text-[1.4rem]"><span class="opacity-60" >➲</span> Return to Projects</span>
              </button>
            </a>
            <a href="/certs" class="text-amber-400">
                <button class="group relative h-12 w-60 overflow-hidden rounded-lg bg-white text-lg shadow-sm mt-4 cursor-pointer">
                    <div class="absolute inset-0 w-3 bg-amber-400 transition-all duration-[250ms] ease-out group-hover:w-full"></div>
                    <span class="relative text-black group-hover:text-white text-[1.4rem]"><span class="opacity-60" >➲</span> Return to Courses</span>
                  </button>
                </a>
          </div>
        </div>
